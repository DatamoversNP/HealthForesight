#!/bin/bash
# Fix startup to use startup.sh script file

RESOURCE_GROUP="${RESOURCE_GROUP:-healthforesight-rg}"
API_APP_NAME="${API_APP_NAME:-healthforesight-api-9016}"

echo "Fixing startup to use startup.sh script..."
echo ""

# First, create the startup.sh script
...
# Set startup command to use startup.sh
echo "2. Setting startup command to use startup.sh..."
