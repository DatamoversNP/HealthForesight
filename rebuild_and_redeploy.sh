#!/bin/bash
# Rebuild Docker image with storage path fix and redeploy
...
echo "=== Rebuilding and Redeploying with Storage Fix ==="
echo ""
...
# Step 3: Build for linux/amd64 with storage fix
echo "Step 3: Rebuilding Docker image for linux/amd64 with storage fix..."
...
# Step 7: Set environment variables including STORAGE_PATH
